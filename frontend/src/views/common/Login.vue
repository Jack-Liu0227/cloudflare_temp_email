...
const { locale, t } = useI18n({
    messages: {
        ...
        zh: {
            login: '登录',
            loginAndBind: '登录并绑定',
            pleaseGetNewEmail: '请先登录，或点击“创建新邮箱”按钮获取一个新的邮箱地址。',
            getNewEmail: '创建新邮箱',
            getNewEmailTip1: '请输入想使用的邮箱名称，仅允许字符：',
            getNewEmailTip2: '留空时将自动生成一个随机邮箱地址。',
            getNewEmailTip3: '你可以从下拉列表中选择域名。',
            credential: '邮箱地址凭证',
            ok: '确定',
            generateName: '生成随机名称',
            help: '帮助',
            credentialInput: '请输入邮箱地址凭证',
            bindUserInfo: '当前已登录用户，登录未绑定邮箱或创建新邮箱时，会自动绑定到当前用户。',
            bindUserAddressError: '绑定邮箱地址到用户时出错',
            autoGeneratedName: '自动生成名称',
            passwordLogin: '密码登录',
            credentialLogin: '凭证登录',
            email: '邮箱',
            password: '密码',
